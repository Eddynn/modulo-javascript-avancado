let ferverAgua = (chaleiraEstaNoFogao, fogaoEstaLigado) => {
    return new Promise((resolve, reject) =>{
        ...
        if(chaleiraEstaNoFogao && fogaoEstaLigado) {
            ...
            const mensagemDeErro = 'é necessário colocar a chaleira com a água e ligar o fogão senão teu cafézinho não vai ficar pronto nunca'
...
async function iniciaProcessoDeFazerCafe(){
    try {
